...
def foods():
    ...
    foods_list = [normalize_food(food) for food in raw_foods]
...
def add_food():
    ...
    if name and expiry and quantity:
        ...
        save_data(FOODS_FILE, foods_list)
...
def add_kitchen():
    ...
    if name and category and quantity:
        ...
        save_data(KITCHEN_FILE, kitchen_list)
...
def add_medicine():
    ...
    if name and quantity and minimum and dose and time and expiry:

        medicines_list = load_data(MEDICINES_FILE)
        ...
        save_data(MEDICINES_FILE, medicines_list)
